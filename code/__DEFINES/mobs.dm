...
#define NUTRITION_LOSS_PER_SECOND 0.2
#define NUTRITION_LOSS_PER_MOVE 0.05
...
#define HYDRATION_LEVEL_START_MAX 800
#define HYDRATION_LEVEL_START_MIN 600

#define HYDRATION_LOSS_PER_SECOND 0.2
...
#define DRINK_HYDRATION_FACTOR_VERY_LOW 0.1
