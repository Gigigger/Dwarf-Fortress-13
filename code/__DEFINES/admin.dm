...
#define ADMIN_QUE_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];adminmoreinfo=[REF(user)]'>?</a>"
#define ADMIN_FLW_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];adminplayerobservefollow=[REF(user)]'>FLW</a>"
#define ADMIN_PP_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];adminplayeropts=[REF(user)]'>PP</a>"
#define ADMIN_VV_NB(atom) "<a href='byond://?_src_=vars;[HrefToken(TRUE)];Vars=[REF(atom)]'>VV</a>"
#define ADMIN_SM_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];subtlemessage=[REF(user)]'>SM</a>"
#define ADMIN_TP_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];traitor=[REF(user)]'>TP</a>"
#define ADMIN_SMITE_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];adminsmite=[REF(user)]'>SMITE</a>"
#define ADMIN_INDIVIDUALLOG_NB(user) "<a href='byond://?_src_=holder;[HrefToken(TRUE)];individuallog=[REF(user)]'>LOGS</a>"
#define ADMIN_SKP(user) "(<a href='byond://?_src_=holder;[HrefToken(TRUE)];skill=[REF(user)]'>SP</a>)"
