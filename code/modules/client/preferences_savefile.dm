...
/datum/preferences/proc/load_preferences()
	...
	*/
	...
	chatter_enabled	= sanitize_integer(chatter_enabled, FALSE, TRUE, initial(chatter_enabled))
	chatter_volume = sanitize_integer(chatter_volume, 1, 100, initial(chatter_volume))
...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["tunic_color"], tunic_color)
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["tunic_color"], tunic_color)
