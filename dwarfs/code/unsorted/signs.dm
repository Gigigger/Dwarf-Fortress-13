...
/obj/structure/sign/proc/write(txt as text, decal_1, decal_2, picked_color)
	sign_text = txt
	cut_overlays()
	...
	if(decal_1 && decal_1 != "none")
		decal_overlay_1 = mutable_appearance('dwarfs/icons/structures/sign_symbols.dmi', decal_1)
		decal_overlay_1.color = text_color
		decal_overlay_1.pixel_w = 7
		decal_overlay_1.pixel_z = 15
		add_overlay(decal_overlay_1)
	if(decal_2 && decal_2 != "none")
		decal_overlay_2 = mutable_appearance('dwarfs/icons/structures/sign_symbols.dmi', decal_2)
		decal_overlay_2.color = text_color
		decal_overlay_2.pixel_w = 17
		decal_overlay_2.pixel_z = 15
