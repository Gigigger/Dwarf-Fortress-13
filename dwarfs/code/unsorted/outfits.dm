...
/datum/outfit/goblin_footsoldier
	...
	back = /obj/item/spear
	back_grade = 1
	back_materials = list(PART_HANDLE=/datum/material/wood/treated, PART_HEAD=/datum/material/bronze)
	head = /obj/item/clothing/head/leather_helmet
	head_grade = 1
	shoes = /obj/item/clothing/shoes/leather_boots
	shoes_grade = 1
...
/datum/outfit/goblin_grunt
	...
	r_hand_grade = 2
	r_hand_materials = list(PART_HANDLE=/datum/material/wood/treated, PART_HEAD=/datum/material/bronze)
	suit = /obj/item/clothing/suit/leather_vest
	suit_grade = 2
	head = /obj/item/clothing/head/leather_helmet
	head_grade = 2
